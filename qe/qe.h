...
public:
    ...
    // To judge whether this tuple satisfies the condition.
...
private:
    ...
    std::vector<Attribute> lhsAttributes;
    std::vector<Attribute> rhsAttributes;
    std::vector<std::string> lhsSelAttrNames;
    std::vector<std::string> rhsSelAttrNames;
...
public:
    ...
    RC doOpForINT(void *data, int offset, int &resultINT);
    RC doOpForREAL(void *data, int offset, float &resultREAL);
